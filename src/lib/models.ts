...
export const AI_MODELS: AIModel[] = [
  ...
  { id: 'claude-opus-4-6', name: 'Claude Opus 4.6', provider: 'anthropic', apiModel: 'claude-opus-4-6' },
  { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', provider: 'anthropic', apiModel: 'claude-sonnet-4-6' },
  { id: 'claude-sonnet', name: 'Claude Sonnet 4', provider: 'anthropic', apiModel: 'claude-sonnet-4-20250514' },
  { id: 'claude-haiku', name: 'Claude Haiku 4.5', provider: 'anthropic', apiModel: 'claude-haiku-4-5-20251001' },
